      ...
      <CardBody className="space-y-6">
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <span className="p-2 rounded-medium bg-default-100">
                <FontAwesomeIcon icon={faIdCard} className="w-5 h-5 text-default-500" />
              </span>
              <div>
                <p className="text-foreground">本地账号密码</p>
                <p className="text-small text-default-500">使用用户名和密码登录</p>
              </div>
            </div>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <span className="p-2 rounded-medium bg-default-100">
                <Icon icon="mdi:github" className="w-5 h-5 text-default-500" />
              </span>
              <div>
                <p className="text-foreground">GitHub OAuth</p>
                <p className="text-small text-default-500">使用 GitHub 账号登录</p>
              </div>
            </div>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <span className="p-2 rounded-medium bg-default-100">
                <Icon icon="simple-icons:cloudflare" className="w-5 h-5 text-default-500" />
              </span>
              <div>
                <p className="text-foreground">Cloudflare OAuth</p>
                <p className="text-small text-default-500">使用 Cloudflare 账号登录</p>
              </div>
            </div>
            <Switch />
          </div>
        ...
        {/* OAuth2 Settings */}
        <div className="space-y-4">
          <h4 className="text-medium font-medium text-foreground">OAuth2 配置</h4>
