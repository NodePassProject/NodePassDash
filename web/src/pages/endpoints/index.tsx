                ...
                <CardBody className="relative h-[140px] bg-gradient-to-br from-content1 to-default-100/50 p-6">
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center gap-2 text-default-400">
                      ...
                      <span className="text-small truncate">{formatUrl(endpoint.url, endpoint.apiPath)}</span>
                    </div>
                    <div className="flex items-center gap-2 text-default-400">
                    ...
                    <TableCell className="w-52">
                      <div className="flex items-center gap-1 justify-start">
                        ...
                        <Tooltip content="查看详情">
                          <Button isIconOnly size="sm" variant="light" color="primary" onPress={()=>navigate(`/endpoints/details?id=${ep.id}`)}>
